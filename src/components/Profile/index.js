...
import { isAuth, removeToken, API } from '../../comfuc/comfuc'
...
const menus = [
  ...
  { id: 5, name: '个人资料', iconfont: 'icon-myinfo',  to:'/editmy'},
  { id: 6, name: '联系我们', iconfont: 'icon-cust' }
]

// 默认头像

const DEFAULT_AVATAR = BASE_URL + '/img/profile/avatar.jpg'
...
export default class Profile extends Component {
  ...
  handleclickG = (a,b) => {
    if (a.id ===3) {
      Toast.fail("权限不够，不能对您开放",2,null,false)
      return
    }
    console.log(a,b)
    if (a.id ===6) {
      window.location.href =  'https://gitee.com/fuxiangyou1_admin/projects'
      return
    }
  }
  render() {
